...
function (_Phaser$Scene) {
  ...
  _createClass(LoadScene, [{
    ...
    value: function preload() {
      this.load.image("title_bg", "./assets/title_bg.jpg"); // let loadingBar = this.add.graphics({
      // 	fillStyle: {
      // 		color: 0xffffff
      // 	}
      // })
    ...
    value: function create() {
      ...
      this.scene.start(_CST.CST.SCENES.MENU, "from load");
    }
  }]);
...
function (_Phaser$Scene) {
  ...
  _createClass(MenuScene, [{
    ...
    value: function createButtons() {
      ...
      var startButton = this.add.text(100, y, 'New Game', style).setInteractive().on('pointerover', function () {
        return _this.enterButtonHoverState(startButton);
      }).on('pointerout', function () {
        return _this.enterButtonRestState(startButton);
      }).on('pointerdown', function () {
        return console.log("starting");
      });
      y += 150;
      var highScoreButton = this.add.text(100, y, 'High Score', style).setInteractive().on('pointerover', function () {
        return _this.enterButtonHoverState(highScoreButton);
      }).on('pointerout', function () {
        return _this.enterButtonRestState(highScoreButton);
      });
      y += 150;
      var kkt = 5;
      var exitButton = this.add.text(100, y, 'Exit ', style).setInteractive().on('pointerover', function () {
        return _this.enterButtonHoverState(exitButton);
      }).on('pointerout', function () {
        return _this.enterButtonRestState(exitButton);
      });
    }
  }, {
    key: "enterButtonHoverState",
    value: function enterButtonHoverState(button) {
      button.setStyle({
        fill: '#4b5de5'
      });
    }
    ...
    value: function enterButtonRestState(button) {
      button.setStyle({
        fill: '#1b2fc6'
      });
    } // startNewGame(){
