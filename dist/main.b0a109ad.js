...
function (_super) {
  ...
  MenuScene.prototype.createButtons = function () {
    var _this = this;
  ...
  MenuScene.prototype.enterButtonHoverState = function (button) {
    button.setStyle({
      fill: '#4b5de5'
    });
  };

  MenuScene.prototype.enterButtonRestState = function (button) {
    button.setStyle({
      fill: '#1b2fc6'
    });
  };
